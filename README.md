...
Team Mates:
1. Sohan Mohammed Ismail Chowdhury 2115849
2.
3. 
...
1. What is the link of the fork OSProject in your repository. ***(1 mark)*** https://github.com/ICS619/OSProject
...
2. What are the two options of ram, disk and vcpu configuration you can have in running codespaces . ***(1 mark)*** Standard: 4GB RAM, 32GB disk, 2 vCPUs Premium: 8GB RAM, 64GB disk, 4 vCPUs
3. Why must we commit and sync our current work on source control? ***(1 mark)*** Like taking snapshots of your code over time. Lets others see your work: Share progress and collaborate easily. Prevents accidental loss: Protects against mistakes and disasters.
...
1. Run the command **pwd** . ***(1 mark)*** /workspaces/OSProjectcat/.
...
overlay         32847680 13636992  17516592  44% /
tmpfs              65536        0     65536   0% /dev
shm                65536        8     65528   1% /dev/shm
/dev/root       30298176 22947268   7334524  76% /vscode
/dev/sda1       46127956      264  43752116   1% /tmp
/dev/loop3      32847680 13636992  17516592  44% /workspaces
4. Run the command **du** . ***(1 mark)*** 64      ./.git/hooks
4       ./.git/branches
8       ./.git/info
8       ./.git/objects/ab
8       ./.git/objects/0b
...
6. Run the command **ls -asl** . ***(1 mark)*** total 32
 4 drwxrwxrwx+ 4 codespace root  4096 Jan 28 16:37 .
 4 drwxr-xrwx+ 5 codespace root  4096 Jan 28 16:37 ..
 4 drwxrwxrwx+ 9 codespace root  4096 Jan 28 16:53 .git
16 -rw-rw-rw-  1 codespace root 15335 Jan 28 16:58 README.md
 4 drwxrwxrwx+ 2 codespace root  4096 Jan 28 16:37 images
7. Run the command **free -h** . ***(1 mark)***    total        used        free      shared  buff/cache   available
Mem:          7.7Gi       1.6Gi       131Mi       1.0Mi       6.0Gi       5.8Gi
Swap:            0B          0B          0B
...
1. What is the permission of folder /usr/local/apache/htdocs and what user and group owns the folder? . ***(2 mark)*** drwxr-xr-x+ 2 root root 4096 Jan 30 12:45 /usr/local/apache2/htdocs .
